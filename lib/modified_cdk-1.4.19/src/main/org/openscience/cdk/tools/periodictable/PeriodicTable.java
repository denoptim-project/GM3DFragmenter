 ...
 *
 * <p>WARNING: class modified to add identification of metals. See the "MFmod"
 * labels in the code.</p>
 *
...
public class PeriodicTable {
    ...
    //MFmod
    public static ArrayList<String> METALELEMENTS = new ArrayList<String>(
    ...
    //MFmod
    /**
     * Return whether the element is a metal
     *
     * @return <code>true</code> if the element corresponds to a metal
     */
    public static boolean isMetal(String symbol)
    {
        return METALELEMENTS.contains(symbol);
    }
    //MFend
