 ...
 *
 * try {
 *    KabschAlignmentMF sa = new KabschAlignmentMF(ac1.getAtoms(),ac2.getAtoms());
 *    sa.align();
 ...
 * @cdk.githash
 */
@TestClass("org.openscience.cdk.geometry.alignment.KabschAlignmentMFTest")
public class KabschAlignmentMF {

	private ILoggingTool logger =
        LoggingToolFactory.createLoggingTool(KabschAlignmentMF.class);
...
//            am[i] = factory.getMajorIsotope( ac.getAtom(i).getSymbol() ).getExactMass();
     ...
     */            
    public KabschAlignmentMF(Atom[] al1, Atom[] al2) throws CDKException {
     ...
     */            
    public KabschAlignmentMF(Atom[] al1, Atom[] al2, double[] wts) throws CDKException {
        if (al1.length != al2.length) {
    ...
    public KabschAlignmentMF(IAtomContainer ac1, IAtomContainer ac2) throws CDKException {
     ...
     */            
    public KabschAlignmentMF(IAtomContainer ac1, IAtomContainer ac2, double[] wts) throws CDKException {
        if (ac1.getAtomCount() != ac2.getAtomCount()) {
            throw new CDKException("The AtomContainer's being aligned must have the same number of atoms");
        }
...
System.out.println("NPoint: "+this.npoint);
